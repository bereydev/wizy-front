...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    'Iconoir:1stMedal': typeof import('~icons/iconoir/1st-medal')['default']
    'Iconoir:addUser': typeof import('~icons/iconoir/add-user')['default']
    'Iconoir:arrowRight': typeof import('~icons/iconoir/arrow-right')['default']
    'Iconoir:calendar': typeof import('~icons/iconoir/calendar')['default']
    'Iconoir:menu': typeof import('~icons/iconoir/menu')['default']
    'Iconoir:modernTv4k': typeof import('~icons/iconoir/modern-tv4k')['default']
    IconoirAddUser: typeof import('~icons/iconoir/add-user')['default']
    ...
    'Noto:wavingHand': typeof import('~icons/noto/waving-hand')['default']
    NotoWavingHand: typeof import('~icons/noto/waving-hand')['default']
